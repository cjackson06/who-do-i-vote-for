...
// Endpoint: POST /api/candidates/analyze
// Request: { sessionId: string, candidates: string[] }
// Response: { analysisId: string, estimatedTime: number }
export const analyzeCandidates = (data: { sessionId: string; candidates: string[] }) => {
  ...
  // try {
  //   return await api.post('/api/candidates/analyze', data);
  // } catch (error) {
